...
print(f"[train_model_distilbert] CUDA available: {use_cuda}")
if use_cuda:
    print(f"[train_model_distilbert] Using GPU: {torch.cuda.get_device_name(0)}")
else:
    print("[train_model_distilbert] Using CPU")
