...
# Explicitly enable GPU usage when available
use_cuda = torch.cuda.is_available()
print(f"[train_model_roberta] CUDA available: {use_cuda}")
if use_cuda:
    print(f"[train_model_roberta] Using GPU: {torch.cuda.get_device_name(0)}")
else:
    print("[train_model_roberta] Using CPU")
...
model.save_pretrained("models/robertabert")
tokenizer.save_pretrained("models/robertabert")